...
document.addEventListener("DOMContentLoaded", function () {
  ...
  wrapper.classList.toggle(currentMode || "light-mode");
  ...
  toggleButton.addEventListener("click", function () {
      ...
      const newMode = wrapper.classList.contains("light-mode") ? "light-mode" : "dark-mode";
...
function getDateTime() {
  ...
  let days = [
   ...
   hour = hour % 12;
   hour = hour === 0 ? 12 : hour; // If hour is 0 (midnight), set it to 12
